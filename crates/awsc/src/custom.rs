...
pub(crate) const IMPLEMENTED: &[(&str, &str, &str)] = &[
    ...
    ("emr", "restore-from-hbase-backup", "Add a step that restores HBase from an S3 backup."),
    ("emr", "schedule-hbase-backup", "Add a step that schedules automated HBase backups."),
