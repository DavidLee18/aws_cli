...
use awsc_model::shape::{Member, StructureShape};
use awsc_model::{Model, Shape, ShapeId};
...
fn namespace(model: &Model, traits: &awsc_model::shape::Traits) -> Option<String> {
    let from = |t: &awsc_model::shape::Traits| {
