...
use awsc_model::naming;
use awsc_model::paginators::PaginatorOverlay;
use awsc_model::{Model, Shape};
...
impl Surface {
    ...
    fn load_one(
        ...
        let table = awsc_model::command_table::build(&model, customizations, custom_surface)
...
fn is_boolean(model: &Model, member: &awsc_model::Member) -> bool {
...
fn is_single_bool_value_struct(model: &Model, member: &awsc_model::Member) -> bool {
